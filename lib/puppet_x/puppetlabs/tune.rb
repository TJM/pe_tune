  ...
  module Puppetlabs
    ...
    class Tune
      ...
      def output_minimum_system_requirements_error(certname)
        output("## Error: #{certname} does not meet the minimum system requirements of 4 CPU and/or 8192 MB RAM\n\n")
      end
      ...
      # mb_console                based upon tuning_monolithic;                                           see also config_java_args: 512
      ...
      def calculate_monolithic_master_settings(resources, with_compile_masters, with_external_postgresql)
        return [{}, {}] unless meets_minimum_system_requirements?(resources)
        ...
        mb_console                = fit_to_memory(resources['ram'], 256, 512, 1024)
        ...
        available_mb_for_puppetserver = resources['ram'] - reserve_mb_os - mb_buffers - mb_puppetdb - mb_console - mb_orchestrator - mb_activemq
        ...
        ram_used = mb_buffers + mb_puppetdb + mb_puppetserver + mb_console + mb_orchestrator + mb_activemq
      ...
      def calculate_master_settings(resources, with_activemq, with_orchestrator)
        ...
        available_mb_for_puppetserver = resources['ram'] - reserve_mb_os - mb_orchestrator - mb_activemq
        if available_mb_for_puppetserver < minimum_mb_puppetserver
          return [{}, {}]
        end
        ...
        ram_used = mb_puppetserver + mb_activemq + mb_orchestrator
        totals['CPU'] = { 'total' => resources['cpu'], 'used' => cpu_used }
        totals['RAM'] = { 'total' => resources['ram'], 'used' => ram_used }
        totals['MB_PER_JRUBY'] = mb_per_puppetserver_jruby
      ...
      # minimum_mb_console based upon tuning_monolithic; see also config_java_args: 512
      ...
      def calculate_console_settings(resources)
        ...
        minimum_mb_console = fit_to_memory(resources['ram'], 256, 512, 1024)
