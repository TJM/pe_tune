...
describe PuppetX::Puppetlabs::Tune do
  ...
  context 'helper methods' do
    ...
    # Refer to tune_calculate_spec.rb for calculate_* methods.
    ...
    it 'can calculate the percentage of a resource limited to a minimum and maximum' do
      expect(tune::percent_of_resource(4096, 50, 1024, 3072)).to eq(2048)
      expect(tune::percent_of_resource(4096, 10, 1024, 3072)).to eq(1024)
      expect(tune::percent_of_resource(4096, 90, 1024, 3072)).to eq(3072)
    end
  end
end
